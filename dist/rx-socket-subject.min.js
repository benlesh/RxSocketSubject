...
0===--e&&k.dispose();w.dispose()}})}}function u(a,b){for(var d in b)b.hasOwnProperty(d)&&(a[d]=b[d]);return a}function b(a){function b(){g||(e=new q,n=d.map(function(a){return"string"===typeof a?{url:a,protocol:null}:a}).s(function(a){console.debug("==>",e);return r.create(function(b){var d=x(a.url,a.protocol,y.create(function(a){p=!0;for(c&&c.a(a);0<k.length;)a=k.shift(),e.a(a)}),h);return new Rx.p(d["catch"](function(a){f&&f.a(a);throw a;})["finally"](function(){p=!1}).b(b),e.b(d))})})["finally"](function(){g=
!1}).w().A(),g=!0);return n}var d=this.connections=a.connections,c=this.f=a.f,f=this.d=a.d,h=this.c=a.c;a=new q;var e=new q,k=[],p=!1;a.b(function(a){p?e.a(a):k.push(a)},function(a){e&&e.v(a)},function(){e&&e.u()});var n,g=!1,m=r.create(function(a){return b().b(a)});v.call(this,a,m)}var f=Rx.h,t=Rx.i,q=Rx.i,r=Rx.h,y=Rx.r,x=Rx.q.t,v=Rx.o;b.prototype=u(Object.create(v.prototype),{constructor:b,l:function(a){return m(this,a)}});b.create=function(a,f,d,c){a instanceof r&&(console.warn("DEPRECATION: RxSocketSubject.create() should be called with a configuration object"),
